...
<sub>One click for the exhaustive view — a Gartner-style reach×engagement quadrant, category and evidence breakdowns, and a full table of all 120 tracked resources. Currently leading by reach: `tensorflow` · `pytorch` · `annotated_deep_learning_paper_implementations` · `keras`. Auto-refreshed from the radar every 3 hours · last update <b>11 Jul 2026, 16:35 UTC</b>.</sub>
<!-- RADAR:END -->
